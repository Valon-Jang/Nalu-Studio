...
- Updated `AGENTS.md`; original backed up when present.

## Remaining manual action
Remove `luna-stage-gate` from GitHub required status checks / rulesets. This local patch cannot change hosted GitHub settings.
